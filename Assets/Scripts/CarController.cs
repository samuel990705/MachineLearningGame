...
public class CarController : MonoBehaviour
{
    ...
    {
		//get input
		horizontalInput = Input.GetAxisRaw("Horizontal");//GetAxisRaw is used to eliminate smoothing so that AI Agent's decision is discrete
		...
		float stiffness = Input.GetKey(KeyCode.Space) == true ? driftingStiffness : defaultStiffness;//change sideway friction stiffness when drifting
